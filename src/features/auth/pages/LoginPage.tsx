...
export const LoginPage: React.FC = () => {
  ...
  const [email, setEmail] = React.useState('alex.morgan@university.edu');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#09090B] p-4">
      <div className="absolute inset-0 bg-gradient-to-tr from-[#7C5CFC]/10 via-transparent to-transparent pointer-events-none" />
      ...
      <Card glass className="w-full max-w-md border-zinc-800 shadow-2xl relative z-10">
        ...
        <CardFooter className="justify-center border-t border-zinc-800/80 pt-4">
          <p className="text-xs text-zinc-400">
            ...
            <Link to={ROUTES.SIGNUP} className="font-semibold text-[#7C5CFC] hover:underline">
              Create an account
            </Link>
          </p>
        </CardFooter>
